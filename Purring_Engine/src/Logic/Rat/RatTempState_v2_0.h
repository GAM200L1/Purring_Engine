...
namespace PE
{
	class RatTempSTATE_v2_0 : public State
	{
		// ----- Destructor ----- //
	public:
		virtual ~RatTempSTATE_v2_0() override { p_data = nullptr; }
	...
	public:
		...
		*************************************************************************************/
		virtual std::string_view GetName() override { return "RatTempSTATE_v2_0"; }
