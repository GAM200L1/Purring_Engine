...
namespace PE
{
		struct HealthBarScript_v2_0_Data
		{
				...
				vec4 fillColorFull{ 1.f, 0.f, 0.f, 1.f };  // Color of the healthbar when it's full
				vec4 fillColorHalf{ 0.f, 1.f, 0.f, 1.f };  // Color of the healthbar when it's half full
				vec4 fillColorAlmostEmpty{ 1.f, 1.f, 0.f, 1.f }; // Color of the healthbar when it's almost empty
		};
