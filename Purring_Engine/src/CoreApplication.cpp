...
void PE::CoreApplication::Run()
{
    ...
    // Create an entity that follows the player's mouse
    EntityID playerId = serializationManager.LoadFromFile("../Assets/Prefabs/Player_Prefab.json");
