    ...
    namespace Audio
    {
        ...
        *************************************************************************************/
        ...
        public:
            ...
            *************************************************************************************/
            void StopEvent(const std::string& r_eventName, bool isImmediate = true);

            /*!***********************************************************************************
             \brief Loads a sound with specified properties.

             \param[in] r_soundName - The name of the sound to load.
            ...
            *************************************************************************************/
            void PlayEvent(const std::string& r_eventName, bool isImmediate = false);
        ...
        private:
            ...
            *************************************************************************************/
            static UniquePtr<FmodStudioManager> p_fmod;
        };
