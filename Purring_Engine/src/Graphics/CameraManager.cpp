...
namespace PE 
{
    namespace Graphics
    {
        ...
        std::optional<std::reference_wrapper<Camera>> CameraManager::GetMainCamera()
        {
            ...
            if (EntityManager::GetInstance().Has(m_mainCameraId, EntityManager::GetInstance().GetComponentID<Graphics::Renderer>()))
            {
        ...
        void CameraManager::UpdateSystem(float deltaTime)
        {
            ...
            // Check if the main camera ID stored is valid
            bool setNewMainCamera{ !EntityManager::GetInstance().Has(m_mainCameraId, EntityManager::GetInstance().GetComponentID<Graphics::Renderer>()) };
